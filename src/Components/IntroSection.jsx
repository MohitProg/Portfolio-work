        ...
        >
          <div className=" flex flex-col  items-center justify-center text-white    p-3">
            <div className="flex w-full lg:w-2/3 flex-col gap-3 text-center sm:text-start  ">
              ...
              <span className="font-semibold text-3xl sm:text-5xl shadow">
                MERN Stack Developer..
              </span>
              <a
                href="https://drive.google.com/uc?export=download&id=1AANEyH2dc4t0sXachfS5pqJUr74XT3sv"
                className="bg-blue-500 text-lg  sm:text-3xl  sm:px-4 mx-auto sm:mx-0 py-2 w-[200px] rounded-lg mt-3 shadow-sm border-none"
              >
                Resume.
                <i className="bi  text-xl ml-3 bi-download"></i>
              </a>
            </div>
          </div>

          <div className="flex items-center justify-center  ">
            <div className="    sm:flex  rounded-[50%] bg-red-300      shadow-sm border-[2px] border-blue-500  items-center justify-center h-[300px] w-[300px] lg:h-[450px] lg:w-[450px] " style={{backgroundImage:`url(${image})`,backgroundPosition:"top",backgroundSize:"cover"}}></div>
          </div>
        </div>
      </section>
    </>
