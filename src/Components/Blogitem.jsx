...
const Blogitem = () => {
  return (
    <Link to="/singleblog">
    <div className='bg-gray-200 transition ease-in-out   border-[2px] hover:border-blue-500 rounded-lg p-1 shadow-lg'>
        <div >
        ...
        <div className='p-2'>
            <h1 className='text-xl font-semibold'>Best Phone in this World is Iphone </h1>
